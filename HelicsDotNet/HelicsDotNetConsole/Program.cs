...
namespace HelicsDotNetConsole
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string netfolder = "C:\\Users\\KP\\Documents\\GitHub\\Natural-gas-common-interface\\Demo\\";
            // Load Gas Model
            ...
            Console.WriteLine("Gas: Setting Federate Info Core Type");
            h.helicsFederateInfoSetCoreName(fedinfo, "Gas Federate Core");
